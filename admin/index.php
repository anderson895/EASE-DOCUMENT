...
<div class="min-h-screen bg-gray-100 flex flex-col">
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <!-- Barangay ID Card -->
            <div id="barangayIDCard" class="bg-white shadow-lg rounded-lg p-6 flex flex-col justify-between">
                <h2 class="text-xl font-bold text-gray-700">Total Request Of Barangay ID</h2>
                <p id="barangayIDCount" class="text-4xl font-extrabold text-blue-500 mt-4">0</p>
            </div>

            <!-- Barangay Clearance Card -->
            <div id="barangayClearanceCard" class="bg-white shadow-lg rounded-lg p-6 flex flex-col justify-between">
                <h2 class="text-xl font-bold text-gray-700">Total Request Of Barangay Clearance</h2>
                <p id="barangayClearanceCount" class="text-4xl font-extrabold text-green-500 mt-4">0</p>
            </div>

            <!-- Residency Card -->
            <div id="residencyCard" class="bg-white shadow-lg rounded-lg p-6 flex flex-col justify-between">
                <h2 class="text-xl font-bold text-gray-700">Total Request Of Residency</h2>
                <p id="residencyCount" class="text-4xl font-extrabold text-red-500 mt-4">0</p>
            </div>

            <!-- Indigency Card -->
            <div id="indigencyCard" class="bg-white shadow-lg rounded-lg p-6 flex flex-col justify-between">
                <h2 class="text-xl font-bold text-gray-700">Total Request Of Indigency</h2>
                <p id="indigencyCount" class="text-4xl font-extrabold text-yellow-500 mt-4">0</p>
            </div>
        </div>
